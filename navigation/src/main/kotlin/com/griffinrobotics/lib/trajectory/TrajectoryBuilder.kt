...
import com.griffinrobotics.lib.trajectory.constraints.TrajectoryAccelerationConstraint
import com.griffinrobotics.lib.trajectory.constraints.TrajectoryVelocityConstraint
...
class TrajectoryBuilder private constructor(
    ...
    fun setAngularConstraints(
        ...
        angAccelOverride: Double = baseAngAccel,
        angJerkOverride: Double = baseAngJerk
    ): TrajectoryBuilder {
