...
class QuinticPolynomial(
     ...
     */
    operator fun get(t: Double): Double = (1 - t).pow(5) * p0 +
            5 * (1 - t).pow(4) * t * p1 +
            10 * (1 - t).pow(3) * t.pow(2) * p2 +
            10 * (1 - t).pow(2) * t.pow(3) * p3 +
            5 * (1 - t) * t.pow(4) * p4 + t.pow(5) * p5

    /**
     * Returns the derivative of the polynomial at `t`.
     */
    fun deriv(t: Double): Double = 5 * ((p5 - 5 * p4 + 10 * p3 - 10 * p2 + 5 * p1 - p0) * t.pow(4) +
            (4 * p4 - 16 * p3 + 24 * p2 - 16 * p1 + 4 * p0) * t.pow(3) +
            (6 * p3 - 18 * p2 + 18 * p1 - 6 * p0) * t.pow(2) +
            (4 * p2 - 8 * p1 + 4 * p0) * t +
            p1 - p0)
     ...
     */
    fun secondDeriv(t: Double): Double = 20 * ((p5 - 5 * p4 + 10 * p3 - 10 * p2 + 5 * p1 - p0) * t.pow(3) +
            (3 * p4 - 12 * p3 + 18 * p2 - 12 * p1 + 3 * p0) * t.pow(2) +
     ...
     */
    fun thirdDeriv(t: Double): Double = 60 * ((p5 - 5 * p4 + 10 * p3 - 10 * p2 + 5 * p1 - p0) * t.pow(2) +
